...
namespace SYSTEM_MANAGEMENT.Areas.HopLong.Controllers
{
    public class COMPANY_CATEGORIESController : Controller
    {
        ...
        // GET: HopLong/COMPANY_CATEGORIES
        public ActionResult Index()
        {
            return View(db.COMPANY_CATEGORIES.ToList());
        }

        // GET: HopLong/COMPANY_CATEGORIES/Details/5
        ...
        // GET: HopLong/COMPANY_CATEGORIES/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: HopLong/COMPANY_CATEGORIES/Create
        ...
        // GET: HopLong/COMPANY_CATEGORIES/Edit/5
        ...
        // POST: HopLong/COMPANY_CATEGORIES/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: HopLong/COMPANY_CATEGORIES/Delete/5
        ...
        // POST: HopLong/COMPANY_CATEGORIES/Delete/5
